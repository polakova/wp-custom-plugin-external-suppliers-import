...
/**
 * VandenbanNL supplier importer
 * Based on ext-stock-vandenban.php (NL part)
 * Uses FTP URL to download CSV: 801169.csv
 * EAN in col[1] (as int), Price in col[13] (with comma), Quantity in col[14]
 */
class Pneupex_VandenbanNL_Importer extends Pneupex_Supplier_Importer_Base {

	public function __construct() {
		parent::__construct( 'VandenbanNL' );
	}
	 ...
	 * Original: ftp://mh040401:...@ftp.pneupex.sk/vandenbancz/801169.csv
	 */
	protected function download_file(): ?string {
		...
		$remote_file = defined( 'PNEUPEX_VANDENBAN_NL_FTP_FILE' ) ? PNEUPEX_VANDENBAN_NL_FTP_FILE : 'vandenbancz/801169.csv';
